...
- [ ] **Phase 4: Live Conversation Mode** - Combine speech input, persona response, TTS output, and interruption handling. (gap closure planned 2026-07-13)
...
- [x] 02-04: Browser playback surface and session-scoped retry
...
- [x] 03-02: VAD provider baseline and turn segmentation
...
- [x] 04-01: Conversation session state and UI controls
...
- [x] 04-03: Interruption handling and turn latency metrics
...
| 4. Live Conversation Mode | 3/4 | Gap closure planned | - |
