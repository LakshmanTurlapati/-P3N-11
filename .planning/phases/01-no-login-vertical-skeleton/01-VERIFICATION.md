...
| 6 | `StudioShell` posts the selected Vesper Glass voice id to `/generate` and renders the structured metadata result card. | ✓ VERIFIED | [apps/web/components/studio-shell.tsx](/Users/akhilasusarla/conductor/workspaces/p3n-11/calgary/apps/web/components/studio-shell.tsx:47) posts `{ voice_id }` to `/generate` and renders provider type, rights check, metadata, trace, and timing; [apps/web/next.config.ts](/Users/akhilasusarla/conductor/workspaces/p3n-11/calgary/apps/web/next.config.ts:1) rewrites `/generate` to the FastAPI control plane; [apps/web/tests/studio-generation.spec.ts](/Users/akhilasusarla/conductor/workspaces/p3n-11/calgary/apps/web/tests/studio-generation.spec.ts:3) exercises the real API-backed result card. |
...
| [apps/web/next.config.ts](/Users/akhilasusarla/conductor/workspaces/p3n-11/calgary/apps/web/next.config.ts) | API rewrite bridge | VERIFIED | Proxies `/generate` and `/voices` to `API_BASE_URL`, defaulting to `127.0.0.1:8000`. |
| [apps/web/playwright.config.ts](/Users/akhilasusarla/conductor/workspaces/p3n-11/calgary/apps/web/playwright.config.ts) | Browser smoke runner | VERIFIED | Starts FastAPI on `127.0.0.1:8000`, builds and starts Next.js on `127.0.0.1:3000`, then runs browser tests. |
...
| [apps/web/tests/studio-generation.spec.ts](/Users/akhilasusarla/conductor/workspaces/p3n-11/calgary/apps/web/tests/studio-generation.spec.ts) | Browser generation contract test | VERIFIED | Proves the result-card contract against the real FastAPI metadata stub through the Next.js rewrite. |
...
| [apps/web/tests/studio-generation.spec.ts](/Users/akhilasusarla/conductor/workspaces/p3n-11/calgary/apps/web/tests/studio-generation.spec.ts:3) | [apps/web/components/studio-shell.tsx](/Users/akhilasusarla/conductor/workspaces/p3n-11/calgary/apps/web/components/studio-shell.tsx:47) | The browser test proves the trigger/result-card loop without introducing Phase 2 controls. | WIRED | Playwright starts FastAPI plus Next.js and checks the real metadata-only response through `/generate`. |
...
_Verified: 2026-07-01T01:55:34Z_
