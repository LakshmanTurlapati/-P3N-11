...
export default defineConfig({
  ...
  webServer: [
    {
      command:
        "cd ../.. && THEATRICAL_VOICE_STUDIO_VAD_FIXTURE=1 THEATRICAL_VOICE_STUDIO_STT_FIXTURE=1 .venv/bin/python -m uvicorn services.api.app.main:app --host 127.0.0.1 --port 8000",
